...
class Parameter:
    ...
    def extract_args(self):
        ...
        # data parameters
        self.parser.add_argument('--data_root', type=str, default='/home/cuhksz-aci-03/Documents/ESTRNN-master/dataset/', help='the path of dataset')
        self.parser.add_argument('--dataset', type=str, default='gopro_ds_lmdb', help='BSD, gopro_ds_lmdb, reds_lmdb')
        self.parser.add_argument('--save_dir', type=str, default='/home/cuhksz-aci-03/Documents/ESTRNN-master/experiment/',
        ...
        # model parameters
        self.parser.add_argument('--model', type=str, default='ESTRNN-RAW', help='type of model to construct')
        ...
        self.parser.add_argument('--test_frames', type=int, default=16,
        ...
        self.parser.add_argument('--test_checkpoint', type=str,
                                 default='/home/cuhksz-aci-03/Documents/ESTRNN-master/model/checkpoints/model_best.pth.tar',
