...
def main():
    ...
    imagename = '/home/cuhksz-aci-03/Documents/UltralLowLightRawVideoISP-main/local_tone_result/0325结果/full_0.png'
    ...
    # output_path = os.path.join('/home/cuhksz-aci-03/Desktop/', 'bm3d_img.png')
    # output = cv2.normalize(y_est**(1/2.2), dst=None, alpha=0, beta=255, norm_type=cv2.NORM_MINMAX).astype(np.uint8)
