...
class BM4DProfile:
    ...
    max_stack_size_ht = 32  # maximum number of similar blocks (maximum size of the 3rd dimension of a 3D array)
    search_window_ht = (7, 7, 7)  # half side length of the search neighborhood for full-search block-matching (BM)
    tau_match = 100 # 2.9527 # 2.9527  # threshold for the block-distance (d-distance)
    ...
    bs_wiener = (5, 5, 5)
    step_wiener = (3, 3, 3)
    max_stack_size_wiener = 64
    search_window_wiener = (7, 7, 7)
    tau_match_wiener = 50 # 0.7689 # 0.7689
    beta_wiener = 2.0
