...
def addMotionField(image, tileSize, motionVectors, overlap=True):
    ...
    if len(motionDrawing.shape) == 2:
        motionDrawing = np.stack([motionDrawing,motionDrawing,motionDrawing],axis=-1)
    ...
    if overlap:
        c = 0
        colors = [(130, 130, 255), (255, 130, 130), (130, 255, 130), (102, 255, 255)]
        # Loop bayer
