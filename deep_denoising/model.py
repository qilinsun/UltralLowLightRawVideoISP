...
#         self.conv1_1 = nn.Sequential(nn.Conv2d(4, 32, kernel_size=3, stride=1, padding=1),
#                                      nn.LeakyReLU(negative_slope=0.2))
#
#         # self.conv1_2 = nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1)
#         self.pool1 = nn.MaxPool2d(kernel_size=2)
#
#         self.conv2_1 = nn.Sequential(nn.Conv2d(32, 64, kernel_size=3, stride=1, padding=1),
#                                      nn.LeakyReLU(negative_slope=0.2))
#         # self.conv2_2 = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1)
#         self.pool2 = nn.MaxPool2d(kernel_size=2)
#
#         self.conv3_1 = nn.Sequential(nn.Conv2d(64, 128, kernel_size=3, stride=1, padding=1),
#                         nn.LeakyReLU(negative_slope=0.2))
#         # self.conv3_2 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
#         self.pool3 = nn.MaxPool2d(kernel_size=2)
#
#         self.conv4_1 = nn.Sequential(nn.Conv2d(128, 256, kernel_size=3, stride=1, padding=1),
#                                      nn.LeakyReLU(negative_slope=0.2),
...
#
#         self.conv5_1 = nn.Sequential(nn.Conv2d(256, 512, kernel_size=3, stride=1, padding=1),
#                                      nn.LeakyReLU(negative_slope=0.2))
#         # self.conv5_2 = nn.Conv2d(512, 512, kernel_size=3, stride=1, padding=1)
#
#         # self.upv6 = nn.ConvTranspose2d(512, 256, 2, stride=2)
#         self.conv6_1 = nn.Sequential(nn.Conv2d(512, 256, kernel_size=3, stride=1, padding=1),
#                         nn.LeakyReLU(negative_slope=0.2))
#         # self.conv6_2 = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1)
#
#         self.upv7 = nn.ConvTranspose2d(256, 128, 2, stride=2)
#         self.conv7_1 = nn.Sequential(nn.Conv2d(256, 128, kernel_size=3, stride=1, padding=1),
#                         nn.LeakyReLU(negative_slope=0.2))
#         # self.conv7_2 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
#
#         self.upv8 = nn.ConvTranspose2d(128, 64, 2, stride=2)
#         self.conv8_1 = nn.Sequential(nn.Conv2d(128, 64, kernel_size=3, stride=1, padding=1),
#                         nn.LeakyReLU(negative_slope=0.2))
#         # self.conv8_2 = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1)
#
#         self.upv9 = nn.ConvTranspose2d(64, 32, 2, stride=2)
#         self.conv9_1 = nn.Sequential(nn.Conv2d(64, 32, kernel_size=3, stride=1, padding=1),
#                         nn.LeakyReLU(negative_slope=0.2))
